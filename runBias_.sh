...
seed1=$6
    ...
    GENERATING1="combine ${datacard}_${CAT}_wIntegral.root -M GenerateOnly -m 125 --setParameters $pdfidx=$truth --expectSignal $mu_inj -t $NGEN --saveToys -n ${SETUP} --freezeParameters $pdfidx,allConstrainedNuisances -s ${seed0} --toysFrequentist"
    echo $GENERATING1
    eval $GENERATING1
